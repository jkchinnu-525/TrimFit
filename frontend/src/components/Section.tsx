...
export default function Section() {
  return (
    <div id="section" className="pt-28 md:pt-32 lg:pt-64 relative">
      ...
      <div className="absolute pt-36 pr-60 top-1/2 left-[0%] -translate-y-1/2 w-[700px] h-[480px] md:w-[980px] md:h-[600px] pointer-events-none">
        <div
      ...
      <div className="relative flex flex-row pb-16 md:pb-32 lg:pb-44">
        <div className="md:px-8 lg:ml-28 relative max-w-full lg:max-w-3xl z-10">
          <div className="flex justify-start items-center rounded-2xl gap-2 max-w-fit bg-[#31484D] p-2 mx-auto ml-2 md:ml-0 md:mx-0">
          ...
          <div className="flex ml-2 lg:ml-0 lg:justify-center md:justify-start">
            <Image
              src="/Text.png"
              alt="section"
              width={420}
              height={100}
              className="pt-4 w-[280px] md:w-[350px] lg:w-[420px] h-auto"
            />
          </div>
          <p className="text-black font-semibold font-'Inter' text-[14px] md:text-[15px] lg:text-[16px] leading-[20px] md:leading-[22px] lg:leading-[24px] mt-8 md:mt-7 lg:mt-8 px-4 md:px-0 text-left">
            Tailoring your resume isn&apos;t just about <br />
            keywords—it&apos;s about positioning yourself{" "}
            <br className="hidden md:block" /> as the solution to the
            employer&apos;s needs.
          </p>
          <div className="flex sm:flex-row gap-4 pr-6 pl-2 md:pl-0 md:gap-4 mt-6 md:mt-7 lg:mt-8 items-center justify-start">
            <div className="bg-transparent h-[44px] w-fit rounded-2xl backdrop-blur-xs cursor-pointer hover:bg-gradient-to-t hover:from-[#4FB3B0]/45 hover:via-[#4FB3B0]/10 hover:to-transparent inline-flex items-center justify-center px-6 shadow-[0px_1.1877729892730713px_4.751091957092285px_0px_rgba(0,0,0,0.25),inset_-0.2969432473182678px_-2.5938864946365356px_0.5938864946365356px_0px_rgba(63,143,141,0.8),inset_0.2969432473182678px_0.5938864946365356px_0.5938864946365356px_0px_rgba(63,143,141,1)] transition-all duration-300">
        ...
        <div className="relative mt-8 md:mt-12 md:absolute md:-right-1 md:top-[35%] md:-translate-y-1/2 z-10 px-2 md:px-0">
          <div className="flex justify-center lg:justify-end">
            <Image
              ...
              width={600}
              height={430}
              className="shadow-[0px_0px_15px_4px_#78B1AF] md:shadow-[0px_0px_25px_6px_#78B1AF] lg:shadow-[0px_0px_30px_8px_#78B1AF] rounded-[32px] md:rounded-[48px] lg:rounded-[64px] border-3 md:border-4 lg:border-6 border-[#3F8F8D]/60 h-[270px] md:h-[320px] lg:h-[430px] w-[500px] md:w-[500px] lg:w-[680px] object-cover"
            />
          </div>
        </div>
      </div>
